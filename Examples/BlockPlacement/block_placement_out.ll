...
@.str.2 = private unnamed_addr constant [16 x i8] c"detaljan ispis\0A\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"kratak ispis\0A\00", align 1
@__const.main.a = private unnamed_addr constant [5 x i32] [i32 1, i32 2, i32 3, i32 4, i32 5], align 16
@.str.4 = private unnamed_addr constant [14 x i8] c"sum(10) = %d\0A\00", align 1
@.str.5 = private unnamed_addr constant [20 x i8] c"process(a, 5) = %d\0A\00", align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @ispisi(i1 noundef zeroext %detaljno) #0 {
entry:
  %detaljno.addr = alloca i8, align 1
  %frombool = zext i1 %detaljno to i8
  store i8 %frombool, ptr %detaljno.addr, align 1
  %0 = load i8, ptr %detaljno.addr, align 1
...
entry:
  ...
  %call1 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i32 noundef %call)
  %arraydecay = getelementptr inbounds [5 x i32], ptr %a, i64 0, i64 0
  %call2 = call i32 @process(ptr noundef %arraydecay, i32 noundef 5)
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef %call2)
  call void @ispisi(i1 noundef zeroext true)
  call void @ispisi(i1 noundef zeroext false)
  ret i32 0
}
