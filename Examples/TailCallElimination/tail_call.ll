...
if.end:                                           ; preds = %entry
  ...
  %mul = mul nsw i32 %3, %4
  %call = call i32 @factorial(i32 noundef %sub, i32 noundef %mul)
...
if.then2:                                         ; preds = %if.end
  ...
  %call = call i32 @gcd(i32 noundef %sub, i32 noundef %6)
  store i32 %call, ptr %retval, align 4
  br label %return
...
if.end3:                                          ; preds = %if.end
  ...
  %call5 = call i32 @gcd(i32 noundef %7, i32 noundef %sub4)
...
if.end:                                           ; preds = %entry
  ...
  %2 = load i32, ptr %n.addr, align 4
  %sub = sub nsw i32 %2, 1
  call void @countdown(i32 noundef %sub)
  br label %return
